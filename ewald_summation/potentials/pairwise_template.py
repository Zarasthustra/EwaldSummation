...
def pairwise(pairwise_pot):
    """Decorator to transform a pairwisely defined potenial/force function into 
    ...
    def Blahblah(config, <parameters>...):
        # define pairwise potential function and pairwise 
        # force function under config and parameters.
        # Both functions should accept input as 
        # (type_particle_i, type_particle_j), (dv, dist)
        # dv: distance vector q_i - q_j
        # dist: dist |q_i - q_j|
        return pairwise_pot, pairwise_force, cutoff
