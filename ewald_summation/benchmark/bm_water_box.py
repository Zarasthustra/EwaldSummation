...
q, v, particle_info, l_box, mol_list = _intializer_WaterBox(5)
steps = 100
test_config = es.SimuConfig(l_box=l_box, PBC=True, neighbor_list=False, particle_info=particle_info, mol_list=mol_list, n_steps=steps, timestep=0.005, temp=500)
init = lambda x,y: (q, v)
